...
- [Getting started](#getting-started)
  ...
  - [2. Describe genomes](#2-describe-genomes)
    ...
    - [2.2 Describe genomes in `genomes.txt` configuration file](#22-describe-genomes-in-genomestxt-file-see-the-genomestxt-configuration-file-section-for-explanations)
